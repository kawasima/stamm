...
![Scrum kanban board built from this prompt](images/kanban-board.png)

*The board above was generated by following this prompt and is reading live data
from a stamm server — columns are stamm status categories, cards are issues, and
dragging a card calls `issue_transition`.*
